...
class Article(forms.Form):
    Name = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Название статьи', 'class': 'form-control'}))
    Text = forms.CharField(widget=forms.Textarea(attrs={'placeholder': 'Текст статьи', 'class': 'form-control'}))
